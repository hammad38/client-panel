...
class DetailClient extends Component {
  ...
  render() {
    ...
    console.log('balance form: ', showBalanceUpdate);
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="btn-group float-right">
                ...
                <button className="btn btn-danger" onClick={this.deleteClient}>Delete</button>
              </div>
            </div>
          </div>
          <hr/>
              ...
              <div className="row">
                ...
                <div className="col-md-4 col-sm-6">
                  <h3 className="pull-right">Balance:
                    ...
                    <small>
                      <a href="#!" onClick={() => this.setState({ showBalanceUpdate: !(this.showBalanceUpdate)})}>
